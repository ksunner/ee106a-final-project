...
def generate_launch_description():
    ...
    plane_a_launch_arg = DeclareLaunchArgument(
        'plane_a',
        default_value='0.019471524961941024'
    )
    plane_b_launch_arg = DeclareLaunchArgument(
        'plane_b',
        default_value='0.9998063805818994'
    )
    plane_c_launch_arg = DeclareLaunchArgument(
        'plane_c',
        default_value='0.002839201186679796'
    )
    plane_d_launch_arg = DeclareLaunchArgument(
        'plane_d',
        default_value='-0.07380581936284682'
    )
    object_color_launch_arg = DeclareLaunchArgument(
        'object_color',
        default_value='blue'
    )
